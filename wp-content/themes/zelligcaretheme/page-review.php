            ...
            <div class="col-xs-12 ry-content">
                <div class="col-xs-12">
                        ...
                        if (have_posts()) :
                            while (have_posts()) : the_post();
                                ...
                                if (!empty(trim(strip_tags($content)))) {
                                    ...
                                    // Default content
                                    echo '<h2>We&rsquo;d Love Your Feedback!</h2>';
                                    echo '<p>How was your experience with us?</p>';
                                }
                            endwhile;
                        endif;
                        ?>
                    ...
                    <div class="button-wrapper good-button">
                        <a href="<?php echo esc_url(home_url('/leave-a-review/')); ?>" class="ry-btn ry-btn-primary">
                        ...
                        <a href="<?php echo esc_url(home_url('/feedback/')); ?>" class="ry-btn ry-btn-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
