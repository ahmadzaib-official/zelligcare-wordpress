                ...
                <div class="col-xs-12 col-md-12 col-lg-12 library-wrapper">
                    ...
                    <div class="col-xs-12 ry-flex">
                        ...
                        if ($blog_query->have_posts()) :
                            ...
                            while ($blog_query->have_posts()) : $blog_query->the_post();
                                ...
                                if (empty($thumbnail_url)) {
                                    $thumbnail_url = get_template_directory_uri() . '/images/homepage/ib.jpg';
                                }
                                ?>
                        ...
                        <?php
                            ...
                            $default_posts = array(
                                array(
                                    'image' => get_template_directory_uri() . '/images/library/_Psychiatry_in_Fifteen_Minutes_Isn_t_Psychiatry_.png',
                                ...
                                array(
                                    'image' => get_template_directory_uri() . '/images/library/Why_Anxiety_Feels_Worse_at_Night.png',
                                ...
                                array(
                                    'image' => get_template_directory_uri() . '/images/library/The_Hidden_Struggle_of_Using_Insurance_for_Mental_Health_Care.png',
                                ...
                                array(
                                    'image' => get_template_directory_uri() . '/images/library/What_to_Expect_at_Your_First_Psychiatry_Appointment.png',
