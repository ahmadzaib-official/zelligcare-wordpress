            ...
            <div class="col-xs-12 ry-content">
                <div class="col-xs-12 col-md-12 col-lg-12 ">
                    <div class="col-xs-12 custom-form-v2">
                        <?php
                        // Get featured image or custom image from meta
                        $form_image = get_the_post_thumbnail_url(get_the_ID(), 'full');
                        if (empty($form_image)) {
                            $form_image = get_post_meta(get_the_ID(), 'zelligcare_form_image', true);
                        }
                        if (empty($form_image)) {
                            $form_image = 'https://static.royacdn.com/Site-656e9e6e-f19a-4ed1-9c29-85197594446c/Homepage_Assets/contact_form_photos.jpg';
                        }
                        ?>
                        <div class="col-xs-12 photo">
                            <img src="<?php echo esc_url($form_image); ?>" loading="lazy" alt="<?php the_title_attribute(); ?>" class="img-responsive">
                        </div>
                        <div class="col-xs-12 form-wrapper">
                            <div>
                                <?php
                                // Use WordPress page content for form intro
                                if (have_posts()) :
                                    while (have_posts()) : the_post();
                                        ...
                                        if (!empty(trim(strip_tags($content)))) {
                                            ...
                                            // Default content
                                            echo '<h3>Referral Form</h3>';
                                            echo '<p>We accept referrals for individuals seeking thoughtful, accessible mental health care.</p>';
                                        }
                                    endwhile;
                                endif;
                                ?>
