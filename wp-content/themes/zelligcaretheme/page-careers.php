            ...
            <div class="col-xs-12 ry-container">
                <div class="col-xs-12 content">
                    <div class="col-xs-12 ry-flex">
                        <?php
                        // Get Why Zellig section
                        $why_zellig_title = get_post_meta(get_the_ID(), 'zelligcare_why_zellig_title', true);
                        if (empty($why_zellig_title)) {
                            $why_zellig_title = 'Why Zellig?';
                        }
                        $why_zellig_content = get_post_meta(get_the_ID(), 'zelligcare_why_zellig_content', true);
                        if (empty($why_zellig_content)) {
                            $why_zellig_content = 'Join us in making mental health care more personal, equitable, and impactful. At Zellig, we\'re building a practice that is as much for clinicians as it is for patients.<br><br>We believe exceptional care starts with supporting the people who provide it.';
                        }
                        ?>
                        <!-- Why Zellig Intro -->
                        <div class="col-xs-12 col-lg-3 each each-1" data-aos-duration="1500" data-aos="fade-right">
                            <div class="col-xs-12 wrapper">
                                <div class="title">
                                    <h3><?php echo esc_html($why_zellig_title); ?></h3>
                                </div>
                                <div class="ry-text">
                                    <p><?php echo wp_kses_post($why_zellig_content); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        $benefits = get_post_meta(get_the_ID(), 'zelligcare_careers_benefits', true);
                        ...
                        foreach ($benefits as $benefit) :
                            ...
                            $benefit_icon = !empty($benefit['icon']) ? $benefit['icon'] : '';
                        ?>
                        <div class="col-xs-12 col-lg-3 each each-2" data-aos-duration="1500" data-aos="fade-right">
                            <?php if ($benefit_icon) : ?>
                            <div class="col-xs-12 icon">
                                <img src="<?php echo esc_url($benefit_icon); ?>" loading="lazy" alt="<?php echo esc_attr($benefit['title']); ?>" class="img-responsive">
                            </div>
                            <?php endif; ?>
                            <div class="col-xs-12 wrapper">
                                <div class="title">
                                ...
                                <div class="ry-text">
                                    <p><?php echo wp_kses_post($benefit['content']); ?></p>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; ?>
                ...
                <div class="col-xs-12 content">
                    <div class="col-xs-12 col-lg-12 ry-flex">
                        <div class="col-xs-12 col-lg-5 each each-left">
                            <div class="col-xs-12 wrapper">
                                <?php
                                // Get Join Us section from meta fields
                                $join_us_title = get_post_meta(get_the_ID(), 'zelligcare_join_us_title', true);
                                if (empty($join_us_title)) {
                                    $join_us_title = 'join us';
                                }
                                $join_us_content = get_post_meta(get_the_ID(), 'zelligcare_join_us_content', true);
                                if (empty($join_us_content)) {
                                    $join_us_content = 'We accept applications on a rolling basis. If our mission resonates with you and you\'re looking for a place to grow and contribute meaningfully, we\'d love to hear from you. Please submit your resume and a cover letter.';
                                }
                                $join_us_instructions = get_post_meta(get_the_ID(), 'zelligcare_join_us_instructions', true);
                                if (empty($join_us_instructions)) {
                                    $join_us_instructions = '<h5>Please include in your cover letter:</h5>
<ul>
...
<li><p>How your experience and goals align with our work</p></li>
                                ...
                                <div class="col-xs-12 top-block">
                                    <div class="ry-headline">
                                        <h2><?php echo esc_html($join_us_title); ?></h2>
                                    </div>
                                    <div class="ry-text">
                                        <p><?php echo wp_kses_post($join_us_content); ?></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 top-block">
                                    <div class="ry-text">
                                        <?php echo wp_kses_post($join_us_instructions); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
