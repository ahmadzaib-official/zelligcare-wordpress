                            ...
                            <div class="col-xs-12 ry-flex">
                                ...
                                >
                                    <div class="footer-brand">
                                        ...
                                        />
                                        <?php $social_links = zelligcare_get_social_links(); ?>
                                        <div class="custom-socmed">
                                            <li>
                                                <a href="<?php echo esc_url($social_links['facebook']); ?>" target="_blank" aria-label="Facebook">
                                            ...
                                            <li>
                                                <a href="<?php echo esc_url($social_links['instagram']); ?>" target="_blank" aria-label="Instagram">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 16 16" width="16" fill="#fff">
                                            ...
                                            <li>
                                                <a href="<?php echo esc_url($social_links['google']); ?>" target="_blank" aria-label="Google">
                                    ...
                                    <div class="col-xs-12 wrapper">
                                        ...
                                        <div class="col-xs-12 details">
                                            ...
                                            <div class="text phone">
                                                <?php 
                                                $phone = zelligcare_get_phone();
                                                $phone_display = zelligcare_get_theme_option('phone_display', $phone);
                                                ?>
                                                <a
                                        ...
                                        <div class="col-xs-12 details">
                                            ...
                                            <div class="text mail">
                                                <?php $email = zelligcare_get_email(); ?>
                                                <a
...
<?php wp_footer(); ?>
<script>
// Initialize AOS when window loads
window.addEventListener('load', function() {
    if (typeof AOS !== 'undefined') {
        ...
        // Manually refresh AOS after a short delay
        setTimeout(function() {
            AOS.refresh();
        }, 1000);
    }
