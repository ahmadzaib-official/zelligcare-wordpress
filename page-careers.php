 ...
 * Intro, benefit cards (repeatable), and join section editable via meta boxes.
 */
...
// Why Zellig section
$intro_heading = get_post_meta(get_the_ID(), 'careers_intro_heading', true);
if (empty($intro_heading)) {
    $intro_heading = 'Why Zellig?';
}
$intro_text = get_post_meta(get_the_ID(), 'careers_intro_text', true);
if (empty($intro_text)) {
    $intro_text = '<p>Join us in making mental health care more personal, equitable, and impactful. At Zellig, we\'re building a practice that is as much for clinicians as it is for patients.<br><br>We believe exceptional care starts with supporting the people who provide it.</p>';
}

// Benefit cards
$benefits = get_post_meta(get_the_ID(), 'careers_benefits', true);
if (!is_array($benefits) || empty($benefits)) {
    $benefits = array(
        array(
            ...
            'title' => 'Transparent, Market-Leading Pay',
            'description' => 'We believe in paying clinicians fairly and transparently. Our compensation is among the best in the field, with options for 1099 contracts or W2 roles with a comprehensive benefits package.',
        ),
        array(
            'icon' => 'https://static.royacdn.com/Site-656e9e6e-f19a-4ed1-9c29-85197594446c/Careers_Page/icon2.png',
            'title' => 'A Supportive, Tech-Forward Practice',
            'description' => 'Administrative burdens are kept off your plate. Our systems—from an award-winning EMR with AI scribe to thoughtfully designed workflows—are built to make your work smoother.',
        ),
        array(
            'icon' => 'https://static.royacdn.com/Site-656e9e6e-f19a-4ed1-9c29-85197594446c/Careers_Page/icon3.png',
            'title' => 'Unmatched Career Development',
            'description' => 'At Zellig, professional growth isn\'t an afterthought. Newer providers are paired with experienced mentors. Teaching, writing, and leadership opportunities are encouraged and supported at every stage.',
        ),
        array(
            'icon' => 'https://static.royacdn.com/Site-656e9e6e-f19a-4ed1-9c29-85197594446c/Careers_Page/icon4.png',
            'title' => 'Mission-Driven Work',
            'description' => 'We are deeply committed to making mental health care more equitable. Through our pro bono program, clinicians are paid while providing low-cost or free care to patients who need it most. Advocacy for causes that matter isn\'t just allowed—it\'s part of who we are.',
        ),
        array(
            'icon' => 'https://static.royacdn.com/Site-656e9e6e-f19a-4ed1-9c29-85197594446c/Careers_Page/icon_5_new.png',
            'title' => 'A Connected Team, Even From Afar',
            'description' => 'Because we spend so much of our lives at work, we believe that genuine connection matters. At Zellig, community isn\'t mandatory—but it\'s thoughtfully supported. From group chats and case discussions to optional meetups and shared projects, we make it easy to build meaningful relationships with your peers.',
        ),
        array(
            'icon' => 'https://static.royacdn.com/Site-656e9e6e-f19a-4ed1-9c29-85197594446c/Careers_Page/icon6.png',
            'title' => 'Autonomy with Support',
            'description' => 'You bring the expertise—we trust you to use it. At Zellig, clinicians have the freedom to craft individualized care plans while still having access to collaborative support when they need it.',
        ),
    );
}

// Join Us section
$join_heading = get_post_meta(get_the_ID(), 'careers_join_heading', true);
if (empty($join_heading)) {
    $join_heading = 'join us';
}
$join_text = get_post_meta(get_the_ID(), 'careers_join_text', true);
if (empty($join_text)) {
    $join_text = 'We accept applications on a rolling basis. If our mission resonates with you and you\'re looking for a place to grow and contribute meaningfully, we\'d love to hear from you. Please submit your resume and a cover letter.';
}
$join_list = get_post_meta(get_the_ID(), 'careers_join_list', true);
if (empty($join_list)) {
    $join_list = '<h5>Please include in your cover letter:</h5>
<ul>
                    ...
                    <div class="col-xs-12 ry-flex">
                        ...
                        <div class="col-xs-12 col-lg-3 each each-2" data-aos-duration="1500" data-aos="fade-right">
                            ...
                            <div class="col-xs-12 icon">
                                <img src="<?php echo esc_url($icon); ?>" loading="lazy" alt="<?php echo esc_attr($title); ?>" class="img-responsive">
                            </div>
                            <?php endif; ?>
                            <div class="col-xs-12 wrapper">
                                <div class="title">
                        ...
                        <div class="col-xs-12 col-lg-5 each each-left">
                            <div class="col-xs-12 wrapper">
                                <div class="col-xs-12 top-block">
                                    ...
                                    <div class="ry-text">
                                        <p><?php echo wp_kses_post($join_text); ?></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 top-block">
                                    <div class="ry-text">
                                        <?php echo wp_kses_post($join_list); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
